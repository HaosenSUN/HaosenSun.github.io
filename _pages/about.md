...
My research focuses on <span style="color:#9370DB;">**Foundation Models**</span>, <span style="color:#9370DB;">**Multimodal Generative AI**</span>, <span style="color:#9370DB;">**Efficient AI**</span>, <span style="color:#9370DB;">**Spatial Reasoning**</span>, and <span style="color:#9370DB;">**Embodied Agents**</span>, with an emphasis on **safety**, **efficiency**, and **interpretability**. I aim to enable machines to understand both structured data (text, images, video) and unstructured 3D data, contributing to **human-centered** and **physically grounded** general AI.
